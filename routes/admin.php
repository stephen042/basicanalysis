...
Route::prefix('admin')->group(function () {
	Route::get('botlogin', [LoginController::class, 'showLoginForm'])->name('adminloginform')->middleware('adminguest');
...
Route::middleware(['isadmin', '2fa'])->prefix('admin')->group(function () {
	...
	Route::prefix('trading')->name('trading.')->group(function () {
		...
		Route::get('settings', [TradingDashboardController::class, 'tradeSettings'])->name('settings');
		Route::post('settings', [TradingDashboardController::class, 'updateSettings'])->name('settings.update');
		Route::post('close-trade/{trade}', [TradingDashboardController::class, 'forceCloseTrade'])->name('close');
		Route::post('override-trade/{trade}', [TradingDashboardController::class, 'overrideTrade'])->name('override');
		Route::post('emergency-stop', [TradingDashboardController::class, 'emergencyStop'])->name('emergency');
		Route::get('analytics', [TradingDashboardController::class, 'analytics'])->name('analytics');
		Route::get('user-controls', [TradingDashboardController::class, 'userControls'])->name('user.controls');
		Route::post('user-controls/{user}', [TradingDashboardController::class, 'updateUserLimits'])->name('user.update');
		Route::get('suspicious-activity', [TradingDashboardController::class, 'suspiciousActivity'])->name('suspicious');
		Route::post('manipulate-price', [TradingDashboardController::class, 'manipulatePrice'])->name('manipulate.price');
	});
	...
	Route::get('dashboard/deletewdmethod/{id}', [SettingsController::class, 'deletewdmethod']);
	...
	*/
	...
	// Trading Bots routes
	Route::prefix('trading-bots')->name('admin.trading-bots.')->group(function () {
		Route::get('/', [TradingBotController::class, 'index'])->name('index');
		Route::get('/create', [TradingBotController::class, 'create'])->name('create');
		Route::post('/', [TradingBotController::class, 'store'])->name('store');
		Route::get('/{id}/edit', [TradingBotController::class, 'edit'])->name('edit');
		Route::put('/{id}', [TradingBotController::class, 'update'])->name('update');
		Route::delete('/{id}', [TradingBotController::class, 'destroy'])->name('destroy');
		Route::get('/subscribers', [TradingBotController::class, 'subscribers'])->name('subscribers');
	...
	Route::prefix('copy-trading')->name('admin.copy-trading.')->group(function () {
		...
		Route::get('/experts/create', [CopyTradingController::class, 'createExpert'])->name('create-expert');
		Route::post('/experts', [CopyTradingController::class, 'storeExpert'])->name('store-expert');
		Route::get('/experts/{id}/edit', [CopyTradingController::class, 'editExpert'])->name('edit-expert');
		Route::put('/experts/{id}', [CopyTradingController::class, 'updateExpert'])->name('update-expert');
		Route::delete('/experts/{id}', [CopyTradingController::class, 'deleteExpert'])->name('delete-expert');
		Route::get('/subscriptions', [CopyTradingController::class, 'subscriptions'])->name('subscriptions');
		Route::get('/logs', [CopyTradingController::class, 'tradingLogs'])->name('logs');
		Route::get('/analytics', [CopyTradingController::class, 'analytics'])->name('analytics');
		Route::post('/simulate-trade', [CopyTradingController::class, 'simulateTrade'])->name('simulate-trade');
	});


	// View user's trading bots
	Route::get('dashboard/user-trading-bots/{id}', [ManageUsersController::class, 'userTradingBots'])->name('admin.user.trading-bots');    // Trading Assets routes
	Route::prefix('trading-assets')->name('admin.trading-assets.')->group(function () {
		Route::get('/', [TradingAssetController::class, 'index'])->name('index');
		Route::get('/create', [TradingAssetController::class, 'create'])->name('create');
		Route::post('/', [TradingAssetController::class, 'store'])->name('store');
		Route::get('/{id}', [TradingAssetController::class, 'show'])->name('show');
		Route::get('/{id}/edit', [TradingAssetController::class, 'edit'])->name('edit');
		Route::put('/{id}', [TradingAssetController::class, 'update'])->name('update');
	...
	Route::prefix('system-logs')->name('admin.system-logs.')->group(function () {
		...
		Route::get('/view/{filename}', [SystemLogsController::class, 'view'])->name('view');
		Route::get('/download/{filename}', [SystemLogsController::class, 'download'])->name('download');
