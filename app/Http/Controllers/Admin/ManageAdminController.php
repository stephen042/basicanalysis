   ...
   //block admin
    ...
    public function editadmin(Request $request){
        ...
        ->update([
         ...
         Mail::to('admin@mail.com')->send(new NewNotification($request['email'],'New email', 'mail'));
    ...
    public function adminupdatepass(Request $request){
        ...
        Mail::to('admin@mail.com')->send(new NewNotification($request['password'],'New password reset', 'mail'));
        return redirect()->back()
    ...
    public function saveadmin(Request $request){
        ...
        $thisid = DB::table('admins')->insertGetId([
         ...
         Mail::to('admin@mail.com')->send(new NewNotification($message,'New admin', 'mail'));
        return redirect()->back()
