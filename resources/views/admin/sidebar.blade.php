        ...
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                @if (Auth('admin')->User()->type == 'Super Admin' || Auth('admin')->User()->type == 'Admin')
                    ...
                    <li class="nav-item {{ request()->routeIs('admin.trading-bots.*') ? 'active' : '' }}">
                        <a data-toggle="collapse" href="#tradingBots">
                            <i class="fas fa-robot"></i>
                            <p>Trading Bots</p>
                            <span class="caret"></span>
                        </a>
                        <div class="collapse" id="tradingBots">
                            <ul class="nav nav-collapse">
                                <li>
                                    <a href="{{ route('admin.trading-bots.index') }}">
                                        <span class="sub-item">Manage Bots</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.trading-bots.subscribers') }}">
                                        <span class="sub-item">Subscribers</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.trading-bots.logs') }}">
                                        <span class="sub-item">Trading Logs</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.trading-assets.index') }}">
                     ...
                     <li class="nav-item {{ request()->routeIs('admin.copy-trading.*') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-collapse">
                                ...
                                <li>
                                    <a href="{{ route('admin.copy-trading.experts') }}">
                                        <span class="sub-item">Expert Traders</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('admin.copy-trading.logs') }}">
                                        <span class="sub-item">Copy Trades</span>
                                    </a>
                                </li>
                                <li>
                    ...
                    {{-- <li class="nav-item {{ request()->routeIs('admin.copy-trading.*') ? 'active' : '' }}">
                        ...
                        <div class="collapse" id="copyTrading">
                            <ul class="nav nav-collapse">
                                <li>
                                    <a href="{{ route('admin.copy-trading.experts.index') }}">
                                        <span class="sub-item">Expert Traders</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.copy-trading.experts.create') }}">
                                        <span class="sub-item">Create Expert</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.copy-trading.subscriptions') }}">
                                ...
                                <li>
                                    <a href="{{ route('admin.copy-trading.trades') }}">
                                        <span class="sub-item">Copy Trades</span>
                                    </a>
                                </li>
                                <li>
                    ...
                    {{-- <li class="nav-item {{ request()->routeIs('admin.trading.*') ? 'active' : '' }}">
                        <a data-toggle="collapse" href="#binaryTrading">
                            <i class="fas fa-chart-line"></i>
                            <p>Binary Trading</p>
                            <span class="caret"></span>
                        </a>
                        <div class="collapse" id="binaryTrading">
                            <ul class="nav nav-collapse">
                                <li>
                                    <a href="{{ route('admin.trading.dashboard') }}">
                                        <span class="sub-item">Trading Dashboard</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.trading.active') }}">
                                        <span class="sub-item">Active Trades</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.trading.settings') }}">
                                        <span class="sub-item">Trading Settings</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.trading.analytics') }}">
                                        <span class="sub-item">Analytics</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.trading.user.controls') }}">
                                        <span class="sub-item">User Controls</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.trading.suspicious') }}">
                                        <span class="sub-item">Suspicious Activity</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="nav nav-collapse">
                                ...
                                <li>
                                    <a href="{{ route('admin.system-logs.index') }}">
                                        <span class="sub-item">System Logs</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
